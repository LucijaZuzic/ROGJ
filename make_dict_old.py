...
file_words_from_txt = open(basedir + "/words_from_txt.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train.txt", "w")
