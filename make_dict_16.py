...
file_words_from_txt = open(basedir + "/words_from_txt16.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word16.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test16.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train16.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test16.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train16.txt", "w")
