...
file_words_from_txt = open(basedir + "/words_from_txt3.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word3.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test3.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train3.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test3.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train3.txt", "w")
