...
all_fileids_test_file = open(basedir + "my_db7_test.fileids", "r") 
...
file_words_from_txt = open(basedir + "/words_from_txt7.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word7.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test7.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train7.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test7.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train7.txt", "w")
