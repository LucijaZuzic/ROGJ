...
file_words_from_txt = open(basedir + "/words_from_txt15.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word15.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test15.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train15.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test15.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train15.txt", "w")
