...
all_fileids_test_file = open(basedir + "my_db3_test.fileids", "r") 
...
file_words_from_txt = open(basedir + "/words_from_txt2.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word2.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test2.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train2.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test2.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train2.txt", "w")
