...
file_words_from_txt = open(basedir + "/words_from_txt1.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word1.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test1.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train1.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test1.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train1.txt", "w")
