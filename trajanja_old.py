...
def find_files(my_home, duration_file, wav_files, txt_files, dbname): 
    ...
    file_names = open(my_home + "/db_files/my_db_" + dbname + ".fieldids", "w")
    file_names.write(file_names_content)
    file_names.close()

    file_text_content = "" 

    for content in ok_text:
    ...
    file_text = open(my_home + "/db_files/my_db_" + dbname + ".transcription", "w") 
...
phone_unknown_file = open(basedir + "/my_db.filler", "w") 
...
dict_file = open(basedir + "/my_db.dic", "w") 
...
phone_known_file = open(basedir + "/my_db.phone", "w") 
phone_known_file.write((text_phones + "SIL\n" + "NOISE"))
phone_known_file.close()
 
all_transcriptions_file = open(basedir + "/my_db.transcription", "w") 
...
all_fileids_file = open(basedir + "/my_db.fileids", "w") 
...
all_transcriptions_test_file = open(basedir + "/my_db_test.transcription", "w") 
...
all_fileids_test_file = open(basedir + "/my_db_test.fileids", "w") 
...
all_transcriptions_train_file = open(basedir + "/my_db_train.transcription", "w") 
...
all_fileids_train_file = open(basedir + "/my_db_train.fileids", "w") 
