...
file_words_from_txt = open(basedir + "/words_from_txt10.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word10.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test10.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train10.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test10.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train10.txt", "w")
