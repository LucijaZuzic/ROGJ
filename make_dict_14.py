...
find_files(basedir, "veprad/podaci-BCN/tekst_popravljeno")

#find_files(basedir, "veprad/podaci_sinteza/sz04/text")

find_files(basedir, "veprad/podaci_sinteza/sz08/text")

find_files(basedir, "veprad/podaci_radio/text/prvi")

find_files(basedir, "txt_sm04")
   
file_words_from_txt = open(basedir + "/words_from_txt14.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word14.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test14.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train14.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test14.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train14.txt", "w")
