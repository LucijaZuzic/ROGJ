...
file_words_from_txt = open(basedir + "/words_from_txt13.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word13.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test13.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train13.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test13.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train13.txt", "w")
