...
all_fileids_test_file = open(basedir + "my_db8_test.fileids", "r") 
...
file_words_from_txt = open(basedir + "/words_from_txt8.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word8.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test8.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train8.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test8.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train8.txt", "w")
