...
def find_files(my_home, duration_file, wav_files, txt_files, dbname):
    ...
    file_names = open(my_home + "/db_files/my_db12_" + dbname + ".fieldids", "w")
    ...
    file_text = open(my_home + "/db_files/my_db12_" + dbname + ".transcription", "w") 
...
phone_unknown_file = open(basedir + "/my_db12.filler", "w") 
...
dict_file = open(basedir + "/my_db12.dic", "w") 
...
phone_known_file = open(basedir + "/my_db12.phone", "w") 
phone_known_file.write((text_phones + "SIL\n" + "NOISE"))
phone_known_file.close()
 
all_transcriptions_file = open(basedir + "/my_db12.transcription", "w") 
...
all_fileids_file = open(basedir + "/my_db12.fileids", "w") 
...
all_transcriptions_test_file = open(basedir + "/my_db12_test.transcription", "w") 
...
all_fileids_test_file = open(basedir + "/my_db12_test.fileids", "w") 
...
all_transcriptions_train_file = open(basedir + "/my_db12_train.transcription", "w") 
...
all_fileids_train_file = open(basedir + "/my_db12_train.fileids", "w") 
