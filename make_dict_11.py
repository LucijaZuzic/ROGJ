...
file_words_from_txt = open(basedir + "/words_from_txt11.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word11.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test11.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train11.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test11.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train11.txt", "w")
