...
all_fileids_test_file = open(basedir + "my_db9_test.fileids", "r") 
...
file_words_from_txt = open(basedir + "/words_from_txt9.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word9.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test9.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train9.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test9.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train9.txt", "w")
