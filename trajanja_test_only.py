...
def find_files(my_home, duration_file, wav_files, txt_files, dbname):
    ...
    file_names = open(my_home + "/db_files/my_db6_" + dbname + ".fieldids", "w")
    ...
    file_text = open(my_home + "/db_files/my_db6_" + dbname + ".transcription", "w") 
...
phone_unknown_file = open(basedir + "/my_db6.filler", "w") 
...
dict_file = open(basedir + "/my_db6.dic", "w") 
...
phone_known_file = open(basedir + "/my_db6.phone", "w") 
phone_known_file.write((text_phones + "SIL\n" + "NOISE"))
phone_known_file.close()
 
all_transcriptions_file = open(basedir + "/my_db6.transcription", "w") 
...
all_fileids_file = open(basedir + "/my_db6.fileids", "w") 
...
all_transcriptions_test_file = open(basedir + "/my_db6_test.transcription", "w") 

text_transcriptions_test = ""

for transcription_test in all_transcriptions_new:
...
all_fileids_test_file = open(basedir + "/my_db6_test.fileids", "w") 

text_fileids_test = ""

for fileid_test in all_fileids_new:
    text_fileids_test += fileid_test + "\n"

all_fileids_test_file.write(text_fileids_test)
all_fileids_test_file.close()

all_transcriptions_train_file = open(basedir + "/my_db6_train.transcription", "w") 
...
for transcription_train in all_transcriptions_new:
    text_transcriptions_train += transcription_train + "\n"

all_transcriptions_train_file.write(text_transcriptions_train)
all_transcriptions_train_file.close()
 
all_fileids_train_file = open(basedir + "/my_db6_train.fileids", "w") 
...
for fileid_train in all_fileids_new:
    text_fileids_train += fileid_train + "\n"
