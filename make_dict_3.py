...
file_words_from_txt = open(basedir + "/words_from_txt4.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word4.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_test4.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_word_train4.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_test4.txt", "w")
...
file_words_from_txt = open(basedir + "/words_from_txt_train4.txt", "w")
